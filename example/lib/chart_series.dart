class FakeChartSeries {
  ...
  Map<DateTime, double> createLine2() {
    ...
    data[DateTime.now().subtract(Duration(minutes: 15))] = 0.45;
    data[DateTime.now().subtract(Duration(minutes: 10))] = 0.45;
    data[DateTime.now().subtract(Duration(minutes: 5))] = 0.45;
  ...
  Map<DateTime, double> createLine2_2() {
    ...
    data[DateTime.now().subtract(Duration(minutes: 15))] = 0.34;
    data[DateTime.now().subtract(Duration(minutes: 10))] = 0.34;
    data[DateTime.now().subtract(Duration(minutes: 5))] = 0.34;
  ...
  Map<DateTime, double> createLine2_3() {
    ...
    data[DateTime.now().subtract(Duration(minutes: 15))] = 0.23;
    data[DateTime.now().subtract(Duration(minutes: 10))] = 0.45;
    data[DateTime.now().subtract(Duration(minutes: 5))] = 0.90;
    return data;
  }
